...
class Aff_Bank_Details {
	...
	public function __construct() {
		...
		add_action( 'affwp_update_affiliate', array( $this, 'process_update_affiliate' ), 1 );
	}
	...
	/**
	 * Admin affiliate edit profile form
	 *
...
add_action('plugins_loaded', 'affwp_bd_init');

function affwp_bd_init() {
	Aff_Bank_Details::get_instance();
}